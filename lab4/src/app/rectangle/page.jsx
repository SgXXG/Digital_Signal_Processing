...
export default function Rectangle () {
  ...
  }, [A, N, T, dc, k, BigK, selectedTimeFilter])
  ...
  }, [A, N, T, dc, k, slice, lowSlice, highSlice, selectedFreqFilter])
        ...
        <div className="sinus-functions-container">
          <div className="params-container">
            ...
            <div className="params-box">
              ...
              <input type="range" onChange={(e) => setT(e.target.value)} value={T} />
              <div className="param-value">{T}</div>
            </div>
            <div className="params-box">
            ...
            <div className="params-box">
              ...
              <input type="range" step={0.01} max={1} onChange={(e) => setDc(e.target.value)} value={dc} />
              <div className="param-value">{dc}</div>
            </div>
